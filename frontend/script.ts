...
function setSessionStorage(userData: IUserData) {
...
async function uploadProfilePicture(username: string, profilePicture: string) {
    try {
        const headers = new Headers();
...
export async function addUserApi(username: string, profilePicture: string) {
