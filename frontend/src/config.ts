...
export const config = {
	...
	frontend: {
		...
		ssl: {	// Configuration SSL pour le service frontend
			key: process.env.FRONTEND_KEY_PATH!,	// Chemin vers la clé SSL
			cert: process.env.FRONTEND_CERT_PATH!,	// Chemin vers le certificat SSL
		},
	},
	api: {
		path: "",
